      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-viridian/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-viridian-dark/80">
            ...
            <Button href={STRIPE_PLACEHOLDER_URL} className="px-5 py-2 text-xs" onClick={() => window.dataLayer.push({ event: 'cta_click', cta_location: 'nav' })}>JOIN FOR $27</Button>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button href={STRIPE_PLACEHOLDER_URL} variant="gradient" className="text-base md:text-lg flex items-center justify-center gap-2 whitespace-nowrap flex-nowrap" onClick={() => window.dataLayer.push({ event: 'cta_click', cta_location: 'hero' })}>
      ...
      <section className="py-24 text-center bg-viridian-accent/30">
        <div className="max-w-4xl mx-auto px-6 space-y-10">
          ...
          <div className="flex flex-col items-center gap-6">
            <Button href={STRIPE_PLACEHOLDER_URL} variant="gradient" className="text-xl md:text-2xl px-8 md:px-12 py-4 md:py-6 whitespace-nowrap" onClick={() => window.dataLayer.push({ event: 'cta_click', cta_location: 'final_cta' })}>SECURE MY SPOT — $27</Button>
